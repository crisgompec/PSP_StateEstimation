...
function m = get_measures_eqs_v2(x, x_ans, params, measures_h)
...
% Takes out the integral for equations 1, 11-16, 20, 21
m(1) = v3-v4;

m(11) = y1 - (lambda/l_0)^2;
m(12) = y2 - y1^2;
m(13) = y3 - y2^2;
m(14) = y4 - y3*y1;
m(15) = im - i_0*lambda/l_0 * y4 - lambda/L_0;
m(16) = -g_b * (v3-v4);
